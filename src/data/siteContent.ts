  ...
  footerGroups: [
    {
      ...
      title: "Services",
      links: [
        { id: "footer-web-development", label: "Websites", href: "/#services" },
        { id: "footer-mobile-apps", label: "Mobile Apps", href: "/#services" },
        { id: "footer-ui-ux-design", label: "UI/UX", href: "/#services" },
        { id: "footer-cloud-solutions", label: "Cloud", href: "/#services" },
    ...
    },
    {
      ...
      title: "Topics",
      links: [
        { id: "footer-topic-web", label: "Websites", href: "/#services" },
        { id: "footer-topic-cloud", label: "Cloud", href: "/#services" },
        { id: "footer-topic-ui", label: "UI/UX", href: "/#services" },
